...
> Pydantic dependencies require precompiled C/Rust binary wheels that are available for **Python 3.11**. Running on Python 3.14 will cause `ModuleNotFoundError: No module named 'pydantic_core._pydantic_core'`.
